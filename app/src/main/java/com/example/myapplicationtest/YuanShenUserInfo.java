...
//        getWindow().setStatusBarColor(getResources().getColor(R.color.wltsztlcolor));
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String javastr = "javascript:document.getElementById(\"cookies\").setAttribute(\"value\","+"\""+cookie+"\")";
                String javastruid = "javascript:document.getElementById(\"uid\").setAttribute(\"value\","+"\""+uid+"\")";
