package com.example.myapplicationtest.novel.activitys.baseInfo;
...
import com.example.myapplicationtest.novel.widget.LoadingView;
import com.example.myapplicationtest.novel.widget.MyAppTitle;
import com.example.myapplicationtest.novel.widget.PubLoadingView;
...
//        getSupportActionBar().hide();
    ...
    protected void onStop() {
        ...
        if (!isAppOnForeground()
                && !this.getClass().getName().equalsIgnoreCase(MainActivity.class.getName())) {
            isActive = false;
        }
    }
