package com.example.myapplicationtest.novel.utils.pops;
...
public class DeleteBookShelfPop implements View.OnClickListener {
    ...
    public void showPop(final Activity activity, final int position, final IDeleteBookShelfPop onListener) {
