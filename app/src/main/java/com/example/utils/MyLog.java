...
public class MyLog {
    ...
    private static char MYLOG_TYPE = 'd';// 输入日志类型，w代表只输出告警信息等，v代表输出所有信息
    private static String MYLOG_PATH_SDCARD_DIR = "/sdcard/Android/data/com.example.myapplicationtest/files/log/";// 日志文件在sdcard中的路径
